...
public class M300 {
    ...
    public M300(Nombre nombre, Color color, Peso peso, Calibre calibre, Dimensiones dimensiones, Cargador cargador, Supresor supresor, Rifle rifle, Culata culata, Accesorio accesorio) {
        this.nombre = nombre;
        this.color = color;
        this.peso = peso;
