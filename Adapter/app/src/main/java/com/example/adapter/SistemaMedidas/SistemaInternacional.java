...
public class SistemaInternacional {
    public static Map<String, Double> metro = new HashMap<String, Double>();
    public static Map<String, Double> centimetro = new HashMap<String, Double>();
    public static Map<String, Double> milimetro = new HashMap<String, Double>();
    public static Map<String, Double> kilogramo = new HashMap<String, Double>();
